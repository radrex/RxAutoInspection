    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperatingLocations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInDevelopment = table.Column<bool>(nullable: false),
                    Description = table.Column<string>(maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employees_OperatingLocations_OperatingLocationId",
                        column: x => x.OperatingLocationId,
                        principalTable: "OperatingLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "JobPositionQualifications",
                columns: table => new
                {
                    JobPositionId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobPositionQualifications", x => new { x.JobPositionId, x.QualificationId });
                    table.ForeignKey(
                        name: "FK_JobPositionQualifications_JobPositions_JobPositionId",
                        column: x => x.JobPositionId,
                        principalTable: "JobPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPositionQualifications_Qualifications_QualificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleMake = table.Column<string>(maxLength: 30, nullable: true),
                    VehicleModel = table.Column<string>(maxLength: 30, nullable: true),
                    LicenseNumber = table.Column<string>(maxLength: 10, nullable: false),
                    PhoneNumber = table.Column<string>(maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceDocument", x => new { x.ServiceId, x.DocumentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ServiceOperatingLocations",
                columns: table => new
                {
                    ServiceId = table.Column<int>(nullable: false),
                    OperatingLocationId = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceOperatingLocations", x => new { x.ServiceId, x.OperatingLocationId });
                    table.ForeignKey(
                        name: "FK_ServiceOperatingLocations_OperatingLocations_OperatingLocationId",
                        column: x => x.OperatingLocationId,
                        principalTable: "OperatingLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceOperatingLocations_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_OperatingLocationId",
                table: "Employees",
                column: "OperatingLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPositionQualifications_QualificationId",
                table: "JobPositionQualifications",
                column: "QualificationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOperatingLocations_OperatingLocationId",
                table: "ServiceOperatingLocations",
                column: "OperatingLocationId");
