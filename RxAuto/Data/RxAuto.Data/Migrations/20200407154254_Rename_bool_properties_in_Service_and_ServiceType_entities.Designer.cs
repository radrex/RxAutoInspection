...
namespace RxAuto.Data.Migrations
{
    ...
    [Migration("20200407154254_Rename_bool_properties_in_Service_and_ServiceType_entities")]
    partial class Rename_bool_properties_in_Service_and_ServiceType_entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RxAuto.Data.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RxAuto.Data.Models.DepartmentPhone", b =>
                {
            ...
            modelBuilder.Entity("RxAuto.Data.Models.Phone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RxAuto.Data.Models.DepartmentPhone", b =>
                {
                    b.HasOne("RxAuto.Data.Models.Department", "Department")
                        .WithMany("Phones")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RxAuto.Data.Models.Phone", "Phone")
                        .WithMany("Departments")
